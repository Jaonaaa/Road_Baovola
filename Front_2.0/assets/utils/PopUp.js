import { createHider } from "./Hider.js";

export function createSidePopUp(content, status) {
...
export function createMiddlePopUp(content) {
  let container = document.createElement("div");
...
export function removeMiddlePopUp() {
